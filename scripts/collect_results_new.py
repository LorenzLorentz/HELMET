...
custom_avgs = {
    ...
    "RULER": ['ruler_niah_mk_2 ruler_recall', 'ruler_niah_mk_3 ruler_recall', 'ruler_niah_mv ruler_recall'],
...
if __name__ == "__main__":
    ...
    config_files = [
        "configs/recall_16k.yaml", # "configs/recall_short.yaml", 
        "configs/rag_16k.yaml", # "configs/rag_short.yaml", 
        "configs/longqa_16k.yaml", # "configs/longqa_short.yaml", 
        "configs/summ_16k.yaml", # "configs/summ_short.yaml", 
        "configs/rerank_16k.yaml", # "configs/rerank_short.yaml", 
        "configs/icl_16k.yaml", # "configs/icl_short.yaml", 
        "configs/cite_16k.yaml", # "configs/cite_short.yaml", 
